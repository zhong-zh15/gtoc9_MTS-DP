...
//mission_neighborhood is a struct that represents a neighborhood of a given mission
...
//tranfer a given all mission sequence to a string
string sequence2string(const std::vector<std::vector<int>>& x);

//tranfer a given single mission sequece and the mission ID to a string
string sequence2string(const std::vector<int>& x, int mission);


/****************************************************************************
* Function     : local_search_1layer
* Discription  : local search algorithm for gtoc9 problem called in multitree_beam.cpp-Localsearch function
...
* Discription  : 
*                compute the neighborhood for single mission sequence
*                input:
*					X: mission sequence
